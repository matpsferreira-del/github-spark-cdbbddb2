...
export default function MessagesSlide({ plan, templates }: PlanSlideProps) {
  ...
  return (
    <div className="p-8">
      ...
      <h2 className="text-3xl font-bold text-foreground mb-2">Mensagens para LinkedIn</h2>
      ...
      <div className="mt-6 flex items-center gap-2 text-sm bg-card border border-border rounded-lg p-4">
        <Phone className="w-4 h-4 text-destructive shrink-0" />
        <span className="text-destructive font-medium">Lembrete importante:</span>
        <span className="text-primary">
          Sempre deixe seu telefone/WhatsApp ao final de cada mensagem. Isso facilita o contato e demonstra proatividade.
        </span>
      </div>
    </div>
  );
