...
export default function DiagnosisSlide({ plan }: PlanSlideProps) {
  ...
  return (
    <div className="p-8">
      ...
      <h2 className="text-3xl font-bold text-foreground mb-6">Diagnóstico SWOT</h2>

      <p className="text-muted-foreground mb-8 leading-relaxed">{swot.summary}</p>

      <div className="grid grid-cols-2 gap-6">
        {/* Forças */}
        <div className="bg-card border border-border rounded-lg p-6">
          <h3 className="text-primary font-bold text-sm tracking-wider mb-4">FORÇAS</h3>
        ...
        {/* Fraquezas */}
        <div className="bg-card border border-border rounded-lg p-6">
          <h3 className="text-destructive font-bold text-sm tracking-wider mb-4">FRAQUEZAS</h3>
          <ul className="space-y-3">
        ...
        {/* Oportunidades */}
        <div className="bg-card border border-border rounded-lg p-6">
          <h3 className="text-primary font-bold text-sm tracking-wider mb-4">OPORTUNIDADES</h3>
          <ul className="space-y-3">
        ...
        {/* Ameaças */}
        <div className="bg-card border border-border rounded-lg p-6">
          <h3 className="text-destructive font-bold text-sm tracking-wider mb-4">AMEAÇAS</h3>
          <ul className="space-y-3">
